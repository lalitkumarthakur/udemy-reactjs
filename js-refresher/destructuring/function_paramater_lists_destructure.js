"use strict";
// What is Function Paramater Lists Destructing ?

// When a function accepts a paramater which is object and if we want to "pull out" the object's properties and make them available as locally scoped variables (variables available only inside function body).

export const functionDe = () => {
	// Normal Way -
